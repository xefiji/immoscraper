...
def db_connect():
	cnx = "{0}://{1}:{2}@{3}/{4}?charset={5}".format(settings.DATABASE['drivername'], settings.DATABASE['username'], settings.DATABASE['password'], settings.DATABASE['host'], settings.DATABASE['database'], settings.DATABASE['charset'])
